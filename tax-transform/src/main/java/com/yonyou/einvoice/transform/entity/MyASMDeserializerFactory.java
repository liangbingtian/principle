...
public class MyASMDeserializerFactory extends ASMDeserializerFactory {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo) throws Exception {
        ...
        Package pkg = MyASMDeserializerFactory.class.getPackage();
        if (pkg != null) {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, classNameType, type(MyJavaBeanDeserializer.class), null);
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(MyJavaBeanDeserializer.class), "scanEnum",
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitMethodInsn(INVOKESTATIC, type(MyJavaBeanDeserializer.class),
                                       "parseArray",
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(MyJavaBeanDeserializer.class), "getFieldType",
...
//                mw.visitInsn(POP);
                ...
                mw.visitMethodInsn(INVOKESPECIAL, //
                                   type(MyJavaBeanDeserializer.class), //
...
//                mw.visitLabel(enumNull_);
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, type(MyJavaBeanDeserializer.class),
        ...
        mw.visitVarInsn(ALOAD, 3);
        mw.visitVarInsn(ILOAD, 4);
        mw.visitMethodInsn(INVOKESPECIAL, type(MyJavaBeanDeserializer.class), //
                           "deserialze", //
                           "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
        mw.visitInsn(ARETURN);
    ...
    private void _createInstance(Context context, MethodVisitor mw) {
        ...
        if (Modifier.isPublic(defaultConstructor.getModifiers())) {
            ...
            mw.visitVarInsn(ALOAD, 1);
            mw.visitVarInsn(ALOAD, 0);
            mw.visitFieldInsn(GETFIELD, type(MyJavaBeanDeserializer.class), "clazz", "Ljava/lang/Class;");
            mw.visitMethodInsn(INVOKESPECIAL, type(MyJavaBeanDeserializer.class), "createInstance",
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 0);
        mw.visitLdcInsn(fieldInfo.name);
        mw.visitMethodInsn(INVOKEVIRTUAL, type(MyJavaBeanDeserializer.class), "getFieldDeserializer",
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            mw.visitInsn(DUP);
            mw.visitTypeInsn(INSTANCEOF, type(MyJavaBeanDeserializer.class));
            mw.visitJumpInsn(IFEQ, instanceOfElse_);
            
            mw.visitTypeInsn(CHECKCAST, type(MyJavaBeanDeserializer.class)); // cast
            mw.visitVarInsn(ALOAD, 1);
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, type(MyJavaBeanDeserializer.class), "deserialze",
                               "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
            mw.visitTypeInsn(CHECKCAST, type(fieldClass)); // cast
            mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
    ...
    private void _init(ClassWriter cw, Context context) {
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitVarInsn(ALOAD, 2);
        mw.visitMethodInsn(INVOKESPECIAL, type(MyJavaBeanDeserializer.class), "<init>",
